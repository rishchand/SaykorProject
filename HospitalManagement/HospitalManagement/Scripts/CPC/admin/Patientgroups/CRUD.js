...
function LoadRxData() {
    ...
    var fname = 'GetView';
    var dataParam = {};
    dataParam.viewDesignName = "dev_patientgroup";
    dataParam.viewName = "patientgroupsbyid";
...
/***************CREATE/UPDATE*************/
/*****************************************/
function CreateNewPtntGrpRecord(id, newRow, datacontent) {
    var prefix = 'Values';
    var fname = 'InsertData';
    var str = "1@2";
    var sign = str.substring(1, 2);
    var displayName = "HK.patientgroups" + sign + id;
