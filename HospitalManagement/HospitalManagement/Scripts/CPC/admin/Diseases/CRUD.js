...
function LoadProjectsData() {
    ...
    var fname = 'GetView';
    var dataParam = {};
    dataParam.viewDesignName = "dev_disease";
    dataParam.viewName = "diseasesbyid";
...
/***************CREATE/UPDATE*************/
/*****************************************/
function CreateNewDiseasesbyidRecord(id, newRow, datacontent) {
    var prefix = 'Values';
    var fname = 'InsertData';
    var str = "1@2";
    var sign = str.substring(1, 2);
    var displayName = "HK.diseases" + sign + id;
