...
function LoadProjectsData() {
    ...
    var fname = 'GetView';
    var dataParam = {};
    dataParam.viewDesignName = "dev_userprofile";
    dataParam.viewName = "userprofilesbyid";
...
/***************CREATE/UPDATE*************/
/*****************************************/
function CreateNewUserProfileRecord(id, newRow, datacontent) {
    var prefix = 'Values';
    var fname = 'InsertData';
    var str = "1@2";
    var sign = str.substring(1, 2);
    var displayName = "HK.userprofiles" + sign + id;
...
/***************DELETE*********************/
/*****************************************/
function DeleteUserProfileRecord(ID) {
    var prefix = 'Values';
