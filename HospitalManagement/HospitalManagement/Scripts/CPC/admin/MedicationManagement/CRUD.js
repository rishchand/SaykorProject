...
/***************LOGIN*********************/
/*****************************************/
function LoginAndLoadMedicationGrid(patientId) {
    $.epic.login(
        "rthompson",
        "",
        function (ret) {
...
/***************READ**********************/
/*****************************************/
function LoadRxData(patientId) {
    screenData.length = 0;
    $.epic.setSessionContext(loginSessionContext);
    var prefix = 'Values';
    var fname = 'GetView';
    var dataParam = {};
    dataParam.viewDesignName = "dev_pntmed";
    dataParam.viewName = "pntmedsbyid";
    ...
    $.epic.query(prefix, fname, dataParam, function (ret) {
        ...
        if (ret.response.success) {
            ...
            alert("view dev_patientgroup failed");
        }
...
/***************CREATE/UPDATE*************/
/*****************************************/
function CreateNewMedicationRecord(id, newRow, datacontent) {
    var prefix = 'Values';
    var fname = 'InsertData';
    var str = "1@2";
    var sign = str.substring(1, 2);
    var displayName = "HK.pntmeds" + sign + id;
    alert(displayName);
    // 1. Call Database
...
/***************DELETE*********************/
/*****************************************/
function DeletePtntGrpRecord(ID) {
    var prefix = 'Values';
